...
```shell
.\mongo-sharding>docker compose build
```
...
```shell
.\mongo-sharding>docker exec -it shard-01-node-a mongosh --port 27017
```
...
```shell
.\mongo-sharding>docker exec -it shard-02-node-a mongosh --port 27017
```
...
```shell
{
	...
	"shards": {
	"rs-shard-01": "rs-shard-01/shard01-a:27017",
	"rs-shard-02": "rs-shard-02/shard02-a:27017"
	},
	"cache_enabled": false,
	"status": "OK"
}
...
```shell
.\mongo-sharding>docker compose down
```
